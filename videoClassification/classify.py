...
from .spatial_transforms import (Compose, Normalize, Scale, CenterCrop, ToTensor,CropOpenCV2)
from .temporal_transforms import LoopPadding

def classify_video(video_dir, video_name, class_names, model, opt,hog=None):
    ...
    if hog is None:
        ...
        spatial_transform = Compose([CropOpenCV2(opt.sample_size, 400) , ToTensor() , Normalize(opt.mean, [1 , 1, 1])])
